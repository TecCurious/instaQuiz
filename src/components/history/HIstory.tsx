...
const History: React.FC<QuizResultsCardProps> = ({ results }) => {
    ...
    if(results.length < 1){
        return <div className='max-w-4xl mx-auto p-4'>
             <h2 className="text-2xl font-bold mb-6 text-gray-800">Your Quiz Attempts</h2>
             <p className='font-semibold ml-5 text-red-500'>You not  Attempted any Quiz</p>
        </div>
    }
...
const ResultMetric: React.FC<ResultMetricProps> = ({ count, label, icon, bgColor }) => {
  return (
    <div className={`${bgColor} rounded-lg p-2 flex flex-col items-center justify-center`}>
